...
class AdminUsersControllerTest < ActionController::TestCase
  ...
  test "should create admin_user" do
    assert_difference('AdminUser.count') do
      post :create, admin_user: { first_name: @admin_user.first_name, last_name: @admin_user.last_name, user_id: @admin_user.user_id }
    end
  ...
  test "should update admin_user" do
    patch :update, id: @admin_user, admin_user: { first_name: @admin_user.first_name, last_name: @admin_user.last_name, user_id: @admin_user.user_id }
    assert_redirected_to admin_user_path(assigns(:admin_user))
  end
