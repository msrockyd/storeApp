...
class UserDetailsControllerTest < ActionController::TestCase
  ...
  test "should create user_detail" do
    assert_difference('UserDetail.count') do
      post :create, user_detail: { first_name: @user_detail.first_name, gender: @user_detail.gender, last_name: @user_detail.last_name, phone_number: @user_detail.phone_number, user_id: @user_detail.user_id }
    end
  ...
  test "should update user_detail" do
    patch :update, id: @user_detail, user_detail: { first_name: @user_detail.first_name, gender: @user_detail.gender, last_name: @user_detail.last_name, phone_number: @user_detail.phone_number, user_id: @user_detail.user_id }
    assert_redirected_to user_detail_path(assigns(:user_detail))
  end
